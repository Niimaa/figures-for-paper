...
data = pd.read_csv('Figure_04.csv')
...
plt.subplot(251)
plt.plot(X, Y1, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y3,3,1,kind='linear')
plt.subplot(251)
plt.plot(X, Y2, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')
#
# x, y = plot_func.smooth_func(X,Y56,3,1,kind='linear')
plt.subplot(251)
plt.plot(X, Y3, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y4,3,1,kind='linear')
plt.subplot(251)
plt.plot(X, Y4, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(252)
plt.plot(X, Y5, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y9,3,1,kind='linear')
plt.subplot(252)
plt.plot(X, Y6, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')

#
# x, y = plot_func.smooth_func(X,Y57,3,1,kind='linear')
plt.subplot(252)
plt.plot(X, Y7, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y10,3,1,kind='linear')
plt.subplot(252)
plt.plot(X, Y8, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(253)
plt.plot(X, Y9, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y64,3,1,kind='linear')
plt.subplot(253)
plt.plot(X, Y10, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')

#
# x, y = plot_func.smooth_func(X,Y66,3,1,kind='linear')
plt.subplot(253)
plt.plot(X, Y11, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y68,3,1,kind='linear')
plt.subplot(253)
plt.plot(X, Y12, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(254)
plt.plot(X, Y13, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y65,3,1,kind='linear')
plt.subplot(254)
plt.plot(X, Y14, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')

#
# x, y = plot_func.smooth_func(X,Y67,3,1,kind='linear')
plt.subplot(254)
plt.plot(X, Y15, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y69,3,1,kind='linear')
plt.subplot(254)
plt.plot(X, Y16, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(2,5,5)
plt.plot(X, Y17, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')

# x, y = plot_func.smooth_func(X,Y15,3,1,kind='linear')
plt.subplot(2,5,5)
plt.plot(X, Y18, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')
#
# x, y = plot_func.smooth_func(X,Y58,3,1,kind='linear')
plt.subplot(2,5,5)
plt.plot(X, Y19, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y16,3,1,kind='linear')
plt.subplot(2,5,5)
plt.plot(X, Y20, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(256)
plt.plot(X, Y21, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y21,3,1,kind='linear')
plt.subplot(256)
plt.plot(X, Y22, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')
#
# x, y = plot_func.smooth_func(X,Y59,3,1,kind='linear')
plt.subplot(256)
plt.plot(X, Y23, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y22,3,1,kind='linear')
plt.subplot(256)
plt.plot(X, Y24, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(257)
plt.plot(X, Y25, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y27,3,1,kind='linear')
plt.subplot(257)
plt.plot(X, Y26, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')
#
# x, y = plot_func.smooth_func(X,Y60,3,1,kind='linear')
plt.subplot(257)
plt.plot(X, Y27, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y28,3,1,kind='linear')
plt.subplot(257)
plt.plot(X, Y28, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(258)
plt.plot(X, Y29, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y72,3,1,kind='linear')
plt.subplot(258)
plt.plot(X, Y30, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')
#
# x, y = plot_func.smooth_func(X,Y74,3,1,kind='linear')
plt.subplot(258)
plt.plot(X, Y31, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y76,3,1,kind='linear')
plt.subplot(258)
plt.plot(X, Y32, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(259)
plt.plot(X, Y33, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y73,3,1,kind='linear')
plt.subplot(259)
plt.plot(X, Y34, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')
#
# x, y = plot_func.smooth_func(X,Y75,3,1,kind='linear')
plt.subplot(259)
plt.plot(X, Y35, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y77,3,1,kind='linear')
plt.subplot(259)
plt.plot(X, Y36, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.subplot(2,5,10)
plt.plot(X, Y37, 'k', linestyle='-',  marker='d', markevery = slice(30,10000,600),  label = 'G_l=20')
#
# x, y = plot_func.smooth_func(X,Y33,3,1,kind='linear')
plt.subplot(2,5,10)
plt.plot(X, Y38, 'k', linestyle='-',  marker='o', markevery = slice(30,10000,600),  label = 'G_l=50')
#
# x, y = plot_func.smooth_func(X,Y61,3,1,kind='linear')
plt.subplot(2,5,10)
plt.plot(X, Y39, 'k', linestyle='-',  marker='+', markevery = slice(30,10000,600), label = 'G_l=80')

# x, y = plot_func.smooth_func(X,Y34,3,1,kind='linear')
plt.subplot(2,5,10)
plt.plot(X, Y40, 'k', linestyle='-',  marker='^', markevery = slice(30,10000,600), label = 'G_l=100')
...
plt.savefig('C:/Nima/ABI/2nd Paper/Figure04(17.03.2020).png')
plt.show()
#~ plt.legend(loc=0)
